...
const GROUP: String = "boss_shards"
...
const MAX_LIFETIME: float = 9.0
const DAMAGE: float = 10.0
const HIT_RADIUS: float = 26.0
const TRAIL_RADIUS: float = 11.0
...
func setup(shard_direction: Vector2, color: Color, bounds: Rect2 = Rect2()) -> void:
	direction = shard_direction.normalized()

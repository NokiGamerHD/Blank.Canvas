...
const TRANSLATIONS: Dictionary = {
	"en": {
		...
		"upgrade.damage": "DAMAGE +50%",
		"upgrade.cooldown": "COOLDOWN -25%",
		"upgrade.count": "+2 PROJECTILES",
		"upgrade.size": "SIZE +50%",
		"upgrade.pierce": "PIERCE +2",
		"upgrade.speed": "SPEED +30%",
		"upgrade.dash": "DASH COOLDOWN -30%",
	...
	"pt_BR": {
		...
		"upgrade.damage": "DANO +50%",
		"upgrade.cooldown": "RECARGA -25%",
		"upgrade.count": "+2 PROJÉTEIS",
		"upgrade.size": "TAMANHO +50%",
		"upgrade.pierce": "PERFURAÇÃO +2",
		"upgrade.speed": "VELOCIDADE +30%",
		"upgrade.dash": "RECARGA DO DASH -30%",
		"ability.name": "HAB. %d",
